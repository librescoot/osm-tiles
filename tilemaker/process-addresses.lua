-- Custom Shortbread-based tile processing with address support
-- Extends base functionality with address data extraction
...
-- Area function: process water polygons, land, and building addresses
function area_function()
    ...
    -- Process building addresses (create centroid point for address)
    if building ~= "" and has_address_tags() then
        process_address_point()
    end
...
function process_address_point()
    LayerAsCentroid("addresses") -- Create point feature
    ...
    -- Only show at highest zoom level to avoid clutter
    MinZoom(14)
end
